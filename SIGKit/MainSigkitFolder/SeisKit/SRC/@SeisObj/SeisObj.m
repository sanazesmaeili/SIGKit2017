classdef SeisObj
    ...
    methods
        function newSeisObj = SeisObj(varargin)
            ...
            %             Datapath = strcat([filepath fs 'Data' fs 'Seismics' fs 'Raw_Data']);
        ...
        function plot(theSeisObj,varargin)
            ...
            elseif strcmp(varargin,'picks')
                ...
                %****10/2/2017
                plot(theSeisObj.ShotXProf,theSeisObj.Pick_time,'bo')
                xlabel('Geophone location')
